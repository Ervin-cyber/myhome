...
export default function AuthCard({ onError }: AuthCardProps): JSX.Element {
                ...
                <div className="bg-gray-800/50 backdrop-blur-xl rounded-3xl p-8 border border-gray-700/50 shadow-2xl">
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center gap-3 cursor-pointer group">
                                <div className="relative">
                                    <input
                                        ...
                                        className="sr-only"
                                    />
                                    <div className={`w-5 h-5 rounded border-2 transition-all ${rememberMe ? 'bg-orange-500 border-orange-500' : 'border-gray-600 group-hover:border-gray-500'}`}>
                                        {rememberMe && (
                            ...
                            <a href="#" className="text-orange-400 text-sm hover:text-orange-300 transition-colors">Forgot password?</a>
                        </div>
